		...
		<div id="myTabContent" class="tab-content">
			...
			<div class="tab-pane active" id="home">
				...
				<div class="lf-seach clearfix"
					...
					<p style="float: left; padding-left: 20px;">打卡记录查询</p>
...
<script type="text/javascript" src="js/b_module/attendanceRuleTjManager/attendanceTuleRecordManager.js"></script>
