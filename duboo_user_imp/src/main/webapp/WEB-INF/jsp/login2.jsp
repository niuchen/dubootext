...
<div class="header1">
    <header>
        <div class="header-left">
              <a href="<%=basePath%>/szwq_portal/index.htm"> <img src="<%=basePath%>logfile/images/LOGO.png" alt="学前教育安全动态监管云平台logo" style="width:193px;height:55px;margin-top: 12px;"></a>
        </div>
...
<!--header end-->
<!--banner begin-->
    <div class="banner-wrap login-wrap global-w">
