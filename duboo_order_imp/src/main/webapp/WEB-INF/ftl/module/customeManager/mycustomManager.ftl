...
<base href="${basepath}">
<meta charset="UTF-8">
<title>我的客户1</title> <#include "/public_css.ftl" >
...
<body>
 ...
 <!--新增联系人开始-->
		...
		<form id="add_custom_phone_form" class="clearfix">
			<!-- <div class="layui-form task-form  clearfix"> -->
				<div class="layui-form-item task-item clearfix">
...
<div class="datils-wrapper clearfix" style="border-top:12px solid #F0f0f0;">
						...
						<div class="panel-body">
							<ul class="tab-pane-content">
								<li>联系人
									...
									<table id="linkman_table"  class="linkman table table-condensed table-bordered table-hover table-striped" style="table-layout:fixed" ></table>
								</li>
								<li>商机
		...
		<div class="dialog-leadingIn clearfix hide2">
			<div class="step">
				第一步：<a href="javascript:void(0)" onclick="downloadTemplate(1);">点击下载</a><span><<客户导入模板>></span>
			</div>
			<div class="step">
				第二步：数据重复时的操作方式：
	...
	<!--导出结束-->
	<!--导入结果信息展示开始-->
	<div  id='myimportResult' class="importResult clearfix  hide2">
	<table class="import-result" id="import_table1">
	...
	<!--导入结果信息展示结束-->
	<!--进度条-->
	<div id ="myprogress" class="progress progress-striped active hide2">
        <div id="myprogress-bar" class="progress-bar progress-bar-warning" aria-valuemax="100" aria-valuemin="0" aria-valuenow="40"  
             style="width:0.1%">  
        </div>  
     </div>  
     
     <div id ="applicationmyprogress" class="progress progress-striped active hide2">
        <div id="applicationmyprogress-bar" class="progress-bar progress-bar-warning" aria-valuemax="100" aria-valuemin="0" aria-valuenow="40"  
             style="width:0.1%">  
        </div>  
     </div>  
 ...
 <div class=" hide2 editCustom" >
		<!-- <div style="color:#999;font-size:15px;border-bottom:1px solid #ddd;padding-bottom:7px;margin-bottom: 18px;">基本信息</div> -->
...
<script type="text/javascript" src="js/b_module/mycustomManager/mycustomManager.js"></script>
